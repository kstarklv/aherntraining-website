...
define("DB_NAME", "330856_ahern1");				// db name
define("DB_USER", "330856_isslasveg");				// db username
define("DB_PASS", "stickfoil33");				// db password
define("DB_HOST", "65.61.140.172");		// db server
